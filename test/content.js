...
describe('Yeoman Generator Tests', function () {
  ...
  describe('Content Tests', function () {
    const assertions = [
      ...
      { filePath: `zebra/.env`, containedString: `TEST_DATABASE_URL="mysql://admin:password@localhost:3309/zebra_database?connection_limit=0&pool_timeout=0&socket_timeout=5"` },
      ...
      { filePath: `zebra/.env`, containedString: `TEST_MYSQL_DATABASE='zebra_database'` },
